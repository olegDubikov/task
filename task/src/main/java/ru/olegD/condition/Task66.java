...
Пусть будут такие периоды в течение суток:
с 6 до 10 - утро, с 11 до 17 - день, с 18 до 22 вечер, с 23 до 5 - ночь.
Задание: Написать код, который выводит в консоль время дня,
к которому относится входящий час
("Утро", "День", "Вечер", "Ночь").
Если число не является каким-либо часом - вывести "Не является часом".
